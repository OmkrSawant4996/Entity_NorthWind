...
namespace Entity_NorthWind
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<EmployeeSalesReport_Result> EmployeeSalesReport(Nullable<System.DateTime> fromDate, Nullable<System.DateTime> toDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<EmployeeSalesReport_Result>("EmployeeSalesReport", fromDateParameter, toDateParameter);
        }
    
        public virtual ObjectResult<ProductReport_Result> ProductReport(string productName, Nullable<int> month, Nullable<int> year)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ProductReport_Result>("ProductReport", productNameParameter, monthParameter, yearParameter);
        }
